...
parser.add_argument("--layerl1_weight", type=float, default=0.0001)
...
def main():
    ...
    with sv.managed_session() as sess:
        ...
        if a.mode == "test":
            ...
            #dir = os.path.join(a.output_dir, 'time')
            #table = file.add_sheet(dir, cell_overwrite_ok=True)
            all_time = 0
            ...
            j = 1
            file = xlwt.Workbook(encoding='utf-8')
            table = file.add_sheet('GGAN_W1', cell_overwrite_ok=True)
